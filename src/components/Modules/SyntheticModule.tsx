          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {currentSession.reactions.map((reaction) => {
                const info = {
                  [AlpinaArchetype.PROFESIONAL]: { name: 'Profesional', color: 'blue', icon: '💼', bg: 'from-blue-500 to-blue-600' },
                  [AlpinaArchetype.CONTROLADOR]: { name: 'Controlador', color: 'green', icon: '📊', bg: 'from-green-500 to-green-600' },
                  [AlpinaArchetype.EMPRENDEDOR]: { name: 'Emprendedor', color: 'orange', icon: '🚀', bg: 'from-orange-500 to-orange-600' },
                  [AlpinaArchetype.GOMOSO_EXPLORADOR]: { name: 'Gomoso/Explorador', color: 'purple', icon: '🎨', bg: 'from-purple-500 to-purple-600' },
                  [AlpinaArchetype.PRAGMATICO]: { name: 'Pragmático', color: 'yellow', icon: '⚡', bg: 'from-yellow-500 to-yellow-600' },
                  [AlpinaArchetype.RESIGNADO]: { name: 'Resignado', color: 'gray', icon: '🌾', bg: 'from-gray-500 to-gray-600' }
                }[reaction.archetype as keyof typeof AlpinaArchetype] || { name: 'Unknown', color: 'gray', icon: '👤', bg: 'from-gray-500 to-gray-600' };
