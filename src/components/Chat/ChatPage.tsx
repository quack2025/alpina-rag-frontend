    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/api/chat`, {
        ...
        headers: {
          ...
          'Authorization': `Bearer ${localStorage.getItem('alpina_auth_token')}`,
        },
        body: JSON.stringify({
          ...
          <div className="max-w-4xl mx-auto text-center py-12">
            ...
            <div className="text-left max-w-2xl mx-auto">
              ...
              <div className="grid gap-2 md:grid-cols-2">
                {[
                  '¿Cuál es la percepción de marca de Alpina en Honduras?',
                  '¿Cómo se compara Alpina con la competencia?',
                  'Muéstrame datos de participación de mercado',
                  '¿Qué dicen los estudios sobre la cobertura de Alpina?',
                ].map((question, index) => (
                  <button
                    key={index}
...
- Su experiencia con Alpina vs competencia
