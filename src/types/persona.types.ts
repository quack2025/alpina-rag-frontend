...
// Los 6 Arquetipos de Alpina Honduras
export const AlpinaArchetype = {
...
export type AlpinaArchetype = typeof AlpinaArchetype[keyof typeof AlpinaArchetype];
...
export const ARCHETYPE_TEMPLATES: Record<AlpinaArchetype, Partial<PersonaCharacteristics>> = {
