...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log('🚀 Alpina RAG Frontend iniciado');
    console.log('🔐 Usuario autenticado:', isAuthenticated());
    
    // Configurar título de la página
    document.title = 'Alpina Alpina RAG System';
    
    // Agregar clase al body para estilos globales
    document.body.classList.add('alpina-rag-app');
    
    return () => {
      document.body.classList.remove('alpina-rag-app');
    };
  }, [isAuthenticated]);
